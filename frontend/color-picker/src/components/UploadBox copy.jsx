...
function UploadBox() {
  ...
  //13/08/2026 {time:  PM}
  const [magnifierLocked, setMagnifierLocked] = useState(false);
  ...
  const handleMouseLeave = () => {
    // আবার image-এ ঢুকলে lens কাজ করবে
  ...
  const handleTouchStart = (e) => {
    ...
    if (!touch || !imageRef.current) return;

    const position = getPixelFromClientPosition(touch.clientX, touch.clientY);
  ...
  // =====================================================
  // MOBILE MAGNIFIER TAP → HIDE
  // =====================================================
  const handleMagnifierTap = (e) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  // =====================================================
  // MAGNIFIER TAP / CLICK → HIDE
  // =====================================================
  const handleMagnifierPointerDown = (e) => {
  e.preventDefault();
  e.stopPropagation();
