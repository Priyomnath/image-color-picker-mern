        ...
        >
          ...
          >
            <div className="d-flex align-items-center gap-3">
              ...
              <div className="text-start">
                <small style={{ color: darkMode ? "#94a3b8" : "#64748b", fontWeight: 600, letterSpacing: ".02em" }}>Total Palettes</small>
                <div style={{ fontSize: "23px", lineHeight: 1.15, fontWeight: 750, color: darkMode ? "#f8fafc" : "#0f172a", marginTop: "4px" }}>{palettes.length}</div>
              </div>
            </div>
          </div>
            ...
            <div className="d-flex align-items-center gap-3">
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  background: darkMode ? "rgba(244,63,94,.14)" : "#fff1f2",
              ...
              <div className="text-start">
                <small style={{ color: darkMode ? "#94a3b8" : "#64748b", fontWeight: 600, letterSpacing: ".02em" }}>Favorites</small>
                <div style={{ fontSize: "23px", lineHeight: 1.15, fontWeight: 750, color: darkMode ? "#f8fafc" : "#0f172a", marginTop: "4px" }}>{favoriteCount}</div>
              </div>
            </div>
          </div>
            ...
            <div className="d-flex align-items-center gap-3">
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  background: darkMode ? "rgba(14,165,233,.14)" : "#eff8ff",
              ...
              <div className="text-start">
                <small style={{ color: darkMode ? "#94a3b8" : "#64748b", fontWeight: 600, letterSpacing: ".02em" }}>Showing</small>
                <div style={{ fontSize: "23px", lineHeight: 1.15, fontWeight: 750, color: darkMode ? "#f8fafc" : "#0f172a", marginTop: "4px" }}>{filteredPalettes.length}</div>
              </div>
            </div>
          </div>
        </div>
