            ...
            >
              ...
              <div
                style={{
                  ...
                  background: darkMode
                    ? "linear-gradient(135deg, #151c2b 0%, #111827 100%)"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <path
                      fill="#34A853"
                      d="M12 21.75c2.64 0 4.85-.87 6.47-2.36l-3.16-2.45c-.87.58-1.98.92-3.31.92-2.55 0-4.71-1.72-5.49-4.04H3.24v2.53A9.75 9.75 0 0 0 12 21.75z"
                    />

                    <path
                      fill="#FBBC05"
                      d="M6.51 13.82A5.86 5.86 0 0 1 6.2 12c0-.63.11-1.24.31-1.82V7.65H3.24A9.75 9.75 0 0 0 2.25 12c0 1.57.38 3.06.99 4.35l3.27-2.53z"
                    />

                    <path
                      fill="#EA4335"
                      d="M12 6.14c1.44 0 2.73.5 3.75 1.48l2.81-2.81C16.85 3.24 14.64 2.25 12 2.25a9.75 9.75 0 0 0-8.76 5.4l3.27 2.53C7.29 7.86 9.45 6.14 12 6.14z"
                    />
                  </svg>
                </div>
              ...
              {/* REAL GOOGLE BUTTON
      This stays above the visual button and receives ALL clicks.
  */}
              <div
                style={{
                  position: "absolute",
